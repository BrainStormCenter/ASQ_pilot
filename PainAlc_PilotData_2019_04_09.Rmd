...
#	RAW DATA ON GITHUB
#data3 <- read.csv(url('https://raw.githubusercontent.com/BrainStormCenter/ASQ_pilot/master/ASQ_pilot_2019_04_09.csv'), header = TRUE)
...
tmp <- select(data_ORIG2, participant_id, max.temp)
...
cor(vars_keep, use = "na.or.complete", method = "spearman")
