...
#	CLEAR data2 FROM THE ENVIRONMENT
...
#	filter out subject who doesn’t belong to any group
data4 <- filter(data3, Groups3 != "NA")


#	CREATING TEMPORARY DATA SUBSET
tmp <- select(data3, participant_id, Groups3)

#	CHECKING THAT THE CHANGE WAS MADE CORRECTLY
filter(tmp, Groups3  == "NA")
