...
data_ORIG <- read.csv("ASQ_pilot_2019_04_17.csv", header = TRUE)
data2 <- read.csv("ASQ_pilot_2019_04_17.csv", header = TRUE)
data2 <- as_tibble(data2)

#	RAW DATA ON GITHUB
#data3 <- read.csv(url('https://raw.githubusercontent.com/BrainStormCenter/ASQ_pilot/master/ASQ_pilot_2019_04_17.csv'), header = TRUE)

#data12 <- read.csv("ASQ_pilot_2019_04_09.csv", header = TRUE, na = "NA")
...
dataFactors <- select_if(data2, is.factor)
...
data4 <- filter(data3, Groups3 != "other")
```
