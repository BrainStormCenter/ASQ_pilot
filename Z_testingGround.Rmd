...
b <- tibble(
  b.var1 = sample(1:10, 10, replace = T),
  b.var2 = sample(1:10, 10, replace = T)
)


c <- tibble(
  c.var1 = sample(1:10, 10, replace = T),
  c.var2 = sample(1:10, 10, replace = T)
)
...
=======
write.csv(dat.asq3, "ASQ_data_2019_04_30.csv", row.names = FALSE)
>>>>>>> 97ad5899e691ab0acfc78002540fe5269088ac22
```
